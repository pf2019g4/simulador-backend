...
public class EscenariosController {
    ...
    public Escenario createEscenario(@ModelAttribute Escenario escenario) {
        return escenarioService.createEscenario(escenario);
    }
    
    @PutMapping("/escenarios/{id}")
    public Escenario createEscenario(@PathVariable("id") Long id,@ModelAttribute Escenario escenario) {
