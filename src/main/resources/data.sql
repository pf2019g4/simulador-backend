...
(1, 'escenario 1',5,'El Grupo Macri es uno de los grupos empresariales más importantes de la Argentina,2​ fundado', 0.0, 1 );

insert into escenario
(id, titulo, maximos_periodos, descripcion, impuesto_porcentaje, estado_id) values
(2, 'escenario 2',5,'El Grupo Macri es uno de los grupos empresariales más importantes de la Argentina,2​ fundado', 0.0, 1 );
        
insert into escenario
(id, titulo, maximos_periodos, descripcion, impuesto_porcentaje, estado_id) values
(3, 'escenario 3',5,'El Grupo Macri es uno de los grupos empresariales más importantes de la Argentina,2​ fundado', 0.0, 1 );
