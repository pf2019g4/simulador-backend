...
(id  , titulo           , descripcion                                                                                                                                                                                                , impuesto_porcentaje, maximos_periodos, nombre_periodos, costo_fijo , costo_variable, produccion_mensual, stock, inventario, calidad, cantidad_vendedores, publicidad, balance_id) VALUES
(1   , 'Anteojos de Sol', 'El mercado de gafas para sol es un mercado de mucho potencial. \nCABA concentra mas del 20% de la venta total del país, y dónde será el territorio de competencia de las distintas marcas que competirán.', '0.35'             , 5               , 'Mes'          , '1000.00'  , '10.00'       , 1500              , 200  , '1000.00' , 5      , 1                  , 1         , 1         ),
(2   , 'escenario 2'    , 'En este escenario vamos ...'                                                                                                                                                                              , '0.00'             , 2               , 'Período'      , '100.00'   , '1.00'        , 100               , 400  ,  '2000.00', 2      , 1                  , 1         , 2         );
...
(1   , '8000.00' , '0.00'            , 4                          , '0.00'     , '0.00'    , '0.00'                , '0.00'     , 5                   , '00000.00'      , 3                        , '8000.00'   , '0.00'                 ),
...
(id  , opcion_id, monto      , descripcion              , periodo_inicio, cantidad_periodos, tipo_cuenta , tipo_flujo_fondo                , tipo_balance              ) VALUES
...
-- empresa_competidora
-- -----------------------------------------------------------------------------
INSERT INTO empresa_competidora
...
(id  , descripcion, escenario_id, tea    , cantidad_cuotas) VALUES
(1   , 'Nación'   , 1           , '30.00', 5              ),
...
-- mercado_periodo
-- -----------------------------------------------------------------------------
INSERT INTO mercado_periodo
(id  , escenario_id, periodo, bajo, medio, alto) VALUES
(1   , 1           , 1      , 1000, 1000 , 80  ),
(2   , 1           , 2      , 1000, 50   , 80  ),
(3   , 1           , 3      , 1000, 50   , 60  ),
(4   , 1           , 4      , 1000, 1000 , 80  ),
...
(id  , nombre            , escenario_id, variacion_costo_variable, variacion_calidad) VALUES
...
-- ponderacion_mercado
-- -----------------------------------------------------------------------------
INSERT INTO ponderacion_mercado
(id  , escenario_id, concepto            , valor    , bajo, medio, alto) VALUES
...
-- ponderacion_puntaje
-- -----------------------------------------------------------------------------
INSERT INTO ponderacion_puntaje
(id  , escenario_id, porcentaje_caja, porcentaje_ventas, porcentaje_renta, porcentaje_escenario) VALUES
(2   , 1           , '30.00'        , '50.00'          , '20.00'         , '10.00'             );

-- -----------------------------------------------------------------------------
-- restriccion_precio
-- -----------------------------------------------------------------------------
INSERT INTO restriccion_precio
(id  , escenario_id, precio_min, precio_max) VALUES
(1   , 1           , '100.00'  , '1300.00' );
...
-- -----------------------------------------------------------------------------
INSERT INTO usuario
(id  , mail                          , foto_url                                                                                                             , nombre_completo          , rol      , curso_id) VALUES
...
(6   , 'admin@admin.com'             , NULL                                                                                                                 , 'admin@admin.com'        , 'ADMIN'  , NULL    );
